-- This is the second tempt to solve a sudoku problem using haskell.
-- Although this solves slightly better than the previous solution, it is still the best solution.
